...
public class ReservationJpaEntity {
    ...
    @Builder
    public ReservationJpaEntity(Integer id, UserJpaEntity user, PerformanceScheduleJpaEntity performanceSchedule, SeatJpaEntity seat, Integer paymentAmount, TicketStatus ticketStatus, LocalDateTime reservationTime) {
        this.id = id;
        this.user = user;
